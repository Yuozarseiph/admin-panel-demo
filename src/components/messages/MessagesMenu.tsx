  ...
  return (
    <Popover placement="bottom-end">
      ...
      <Popover.Content className="z-[9999] border-0 bg-transparent p-0">
        <div className="w-[340px] sm:w-[380px] 2xl:w-[420px] rounded-2xl bg-white text-left shadow-[0_18px_45px_rgba(15,23,42,0.12)] ring-1 ring-gray-200 rtl:text-right dark:bg-gray-900 dark:ring-gray-800">
          <div className="mb-1 flex items-center justify-between px-5 pt-4 pb-2">
          ...
          <div className="custom-scrollbar max-h-[406px] overflow-y-auto scroll-smooth py-1">
                ...
                >
                  ...
                  <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center">
                    <div className="w-full">
                      ...
                      <div className="flex">
                        <Text className="w-10/12 truncate pe-7 text-xs text-gray-500 dark:text-gray-300">
                          {item.message}
                        </Text>
                        <Text className="ms-auto whitespace-nowrap pe-6 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <div className="ms-auto flex-shrink-0">
                      {item.unRead ? (
                        // دات آبی واضح و کاملاً تحت کنترل خودت
